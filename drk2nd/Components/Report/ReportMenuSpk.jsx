...
export default function ReportMenuSpk() {
  return (
    <section class="p-4">
  <ul class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
    <li>
      <Link href="/report/user" data-clickable="Category:55:category-card"
    ...
    <li>
        <Link href="/report/absensi" data-clickable="Category:20:category-card"
        class="block h-full transition-all duration-200 bg-white border rounded group shadow-lg border-green-500 ring-1 ring-green-500/20">
        <div class="flex items-center p-6">
          <div
            class="flex items-center justify-center flex-shrink-0 w-16 h-16 transition-colors duration-200 rounded bg-green-50 group-hover:bg-green-100">
