...
export default function ContactUs() {
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Lebih dekat dengan kami</h2>
      <p class="mt-6 text-lg leading-8 text-gray-600">Jika butuh pertanyaan atau info mengenai bengkel maupun lowongan? Dapat menghubungi</p>
    </div>
    <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-4">
      <div class="flex flex-col gap-y-12 rounded-2xl bg-gray-50 p-6 shadow-sm">
        <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-orange-500 shadow-sm">
        ...
        <div class="flex flex-auto flex-col items-start">
          ...
          <a href="#" class="mt-4 inline-block text-base font-semibold text-gray-900">sales@example.com</a>
        </div>
      </div>
      <div class="flex flex-col gap-y-12 rounded-2xl bg-gray-50 p-6 shadow-sm">
        <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-orange-500 shadow-sm">
        ...
        <div class="flex flex-auto flex-col items-start">
          ...
          <a href="#" class="mt-4 inline-block text-base font-semibold text-gray-900">support@example.com</a>
        </div>
      </div>
      <div class="flex flex-col gap-y-12 rounded-2xl bg-gray-50 p-6 shadow-sm">
        <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-orange-500">
          <svg class="h-6 w-6 text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div class="flex flex-auto flex-col items-start">
          ...
          <a href="#" class="mt-4 inline-block text-base font-semibold text-gray-900">Get directions</a>
        </div>
      </div>
      <div class="flex flex-col gap-y-12 rounded-2xl bg-gray-50 p-6 shadow-sm">
        <div class="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-orange-500 shadow-sm">
        ...
        <div class="flex flex-auto flex-col items-start">
          ...
          <a href="#" class="mt-4 inline-block text-base font-semibold text-gray-900">+1 (555) 123-4567</a>
        </div>
      </div>
    </div>
  </div>
